...
class StockAgentTests(unittest.TestCase):
    def test_fetch_board_quotes_parses_ai_agent_board(self):
        ...
        self.assertEqual(quotes[0]["source"], "东方财富 AI智能体(BK0809)")
            ...
            return [
                {
                    ...
                    "turnover_rate": 0.0,
                    "float_market_cap": 3_020_503_316,
                    "pe": 0.0,
                    "amplitude": 4.54,
                    "open": 18.27,
                    "prev_close": 18.27,
    ...
    def test_filter_candidates_removes_bse_st_and_empty_rows(self):
        rows = [
            {"symbol": "300130", "name": "新国都", "price": 23.69, "turnover": 1, "float_market_cap": 3_020_503_316},
    ...
    def test_agent_context_contains_structured_market_data_not_final_recommendation(self):
        ...
        self.assertIn('"board_code": "BK0809"', context)
    ...
    def test_generate_ai_report_uses_llm_result(self):
        ...
        self.assertEqual(report, "AI最终推荐：观望或轻仓。")
